...
- `POLYWEATHER_OBSERVATION_COLLECTOR_*_SEC`（各来源轮询间隔：MADIS 300 / COWIN 60 / HKO 600 / JMA 600 / MSS 60 / FMI 600 / KNMI 600 / IMS 600 / AEROWEB 900 / METAR 1800）
...
- `POLYWEATHER_TRAINING_SETTLEMENT_SKIP_ANALYSIS`（默认 true）/ `POLYWEATHER_TRAINING_SETTLEMENT_ANALYSIS_BATCH_SIZE`（默认 12，false 时每周期轮转分析 N 城，0 = 全量）
...
POLYWEATHER_TRAINING_SETTLEMENT_ANALYSIS_BATCH_SIZE=12
